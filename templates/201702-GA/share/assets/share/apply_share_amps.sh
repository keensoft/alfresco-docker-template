...
echo
echo "This script will apply all the AMPs in amps_share to the share.war file in $CATALINA_HOME/webapps"
...
echo "About to clean out $ALF_HOME/tomcat/webapps/share directory and temporary files..."
echo "Press control-c to stop this script . . ."
echo "Press any other key to continue . . ."
read DUMMY
